...
venue: "My Home Office Boulder"        # brief name of host site without address (e.g., "Euphoric State University")
...
helper: ["Phil Pegion"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
